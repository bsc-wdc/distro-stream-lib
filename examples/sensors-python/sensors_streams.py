...
@constraint(computing_units=CORES_CLOSE)
@task(fds_filtered=STREAM_OUT)
def close_stream(fds_filtered, *args):
    if __debug__:
        print("[DEBUG] Received tokens from big_filters: " + str(args))
